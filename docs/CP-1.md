...
<nav>
  <div class="container" style="display:flex; justify-content:space-between; align-items:center; width:100%;">
    ...
    <ul class="nav-links">
      ...
      <li><a href="https://drive.google.com/file/d/1rX5eIHrKduvFtwxNV6yCdi905bsHMQzC/preview" target="_blank">CV</a></li>
    </ul>
  </div>
</nav>
```
  ...
  <footer>
    <div class="container">
      ...
      <div class="footer-links">
        ...
        <a href="https://drive.google.com/file/d/1rX5eIHrKduvFtwxNV6yCdi905bsHMQzC/preview" target="_blank">CV</a>
      </div>
    </div>
  </footer>
